...
const CustomToolTipContent = ({ payload, setActiveIndex } : { payload?: any; setActiveIndex: CallableFunction }) => {
...
const ActiveDot = ({ payload, setActiveIndex } : { payload?: any; setActiveIndex: CallableFunction }) => {
