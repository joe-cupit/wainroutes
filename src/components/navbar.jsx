...
export function Navbar() {
  ...
  function clickListener(e) {
    ...
    if (!e.composedPath().includes(mobileTarget)) openCloseMobile(false);
  }
  ...
  return (
    <header className="navbar">
      ...
      <div className="flex-row align-center justify-apart">
        ...
        <div className="flex-row justify-center navbar-right">
      ...
      <div id="navbar-mobile" className={"navbar-mobile" + (showMobile ? " active" : "")}>
        ...
        <nav>
          <ul className="flex-column heading">
            ...
            <li onClick={() => openCloseMobile(false)}><Link to="/mountains">mountains</Link></li>
