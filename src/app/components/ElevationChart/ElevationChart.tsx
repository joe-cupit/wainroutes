...
const CustomToolTipContent = ({ payload, setActiveIndex } : { payload?: TooltipPayload[]; setActiveIndex: CallableFunction }) => {

  useEffect(() => {
    if (!((payload?.length ?? 0) > 0)) setActiveIndex(null);
  }, [payload, setActiveIndex])
