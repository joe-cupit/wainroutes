...
export function generateMetadata() {
  return createPageMetadata({
    title: "About",
    description:
      "Wainroutes makes planning walks in the Lake District easier and more enjoyable, with detailed routes and maps, mountain weather forecasts, and photos.",
    path: "/about",
    imageURL:
      "https://images.wainroutes.co.uk/about/walking-the-dog-on-derwentwater-at-sunset_1024w.webp",
  });
}
      ...
      <PageLinkGrid
        ...
        pages={[
          ...
          },
          {
            ...
            href: "/contact",
            imageSrc:
              "contact/curious-sheep-on-a-lake-district-mountainside-thumb.webp",
