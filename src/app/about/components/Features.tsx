...
import { MapIcon, MoreIcon, PhotoIcon, RouteIcon, WeatherIcon } from "@/icons/MaterialIcons";
          ...
          <div className={styles.featureGridContainer}>
            <ul className={styles.featureGrid}>
              <li>
                ...
                <p>Guides for each walk I used to climb the Wainwrights, including notable waypoints.</p>
              </li>
              <li>
                <MapIcon />
                <h3 className={fontStyles.subheading}>Maps and GPX</h3>
                <p>Freely available GPX files and maps to help you follow the routes yourself.</p>
              </li>
              <li>
                <WeatherIcon />
                <h3 className={fontStyles.subheading}>Mountain weather</h3>
                <p>Up-to-date 5-day mountain weather forecasts from the Met Office to help plan your walks.</p>
              </li>
              <li>
                <PhotoIcon />
