...
export default function WeatherClient({
  ...
  return (
    <>
        ...
        {weatherData.days.map((day, index: number) => {
          ...
          return (
            ...
            >
              ...
              <span className={`${fontStyles.subtext} ${styles.weatherDay}`}>
                {dayDate.getDate()}
              </span>
            </button>
          );
      ...
      {selectedDayWeather && (
        <div
          className={`${styles.section} ${styles.weatherBody} ${
            displayNightData ? styles.nightView : ""
          }`}
        >
          <div className={styles.weatherHeader}>
            <h3 className={fontStyles.subheading}>
              {formatDate(selectedDayWeather.date)}
            </h3>
            <div className={styles.dayNight}>
              <button
                className={!displayNightData ? styles.active : ""}
          ...
          <div className={styles.weatherMain}>
            <div className={styles.weatherMainRow}>
              <div className={styles.weatherMainCol}>
                <span className={`${styles.weatherTemps} ${fontStyles.title}`}>
                  {displayTemperature(
              ...
              <div
                className={styles.weatherSymbol}
                title={selectedDayWeather.weather_type[displayNightData]}
              >
                {RenderWeatherIcon(
                  selectedDayWeather.weather_type[displayNightData]
                )}
              </div>
            </div>
            <div className={styles.weatherGrid}>
              ...
              <div className={styles.weatherGridBox}>
                ...
                <p>
                  {displaySpeed(
                    selectedDayWeather.wind.speed[displayNightData]
                  ) +
                    " (" +
                    displaySpeed(
